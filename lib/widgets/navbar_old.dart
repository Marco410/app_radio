...
class NavbarOld extends StatefulWidget implements PreferredSizeWidget {
  final String title;
  ...
  @override
  _NavbarOldState createState() => _NavbarOldState();

  @override
  Size get preferredSize => Size.fromHeight(_prefferedHeight);
}

class _NavbarOldState extends State<NavbarOld> {
